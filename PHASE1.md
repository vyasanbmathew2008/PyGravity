...
The server should start on localhost, serve the frontend, and use the current working directory as the workspace.
...
Clicking a file should load it into Monaco through the backend.
...
Only allow filesystem operations inside the selected workspace.
